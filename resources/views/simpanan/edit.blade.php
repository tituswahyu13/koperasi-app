                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ url('anggota/' . $anggota->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="w-full border-gray-300 rounded-md bg-gray-100 p-2">{{ $anggota->user->username ?? 'Tidak ada username' }}</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="saldo_pokok" class="w-full border-gray-300 rounded-md bg-gray-100"
                                value="Rp {{ number_format($anggota->saldo_pokok ?? 0, 0, ',', '.') }}" disabled>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="simpanan_wajib_khusus" id="simpanan_wajib_khusus" class="w-full border-gray-300 rounded-md" value="{{ old('simpanan_wajib_khusus', $anggota->simpanan_wajib_khusus ?? 0) }}" required min="0">
                        ...
                        <div class="mb-4">
                            <label for="saldo_mandiri" class="block text-gray-700">Saldo Mandiri / Voucher (Saldo Langsung)</label>
